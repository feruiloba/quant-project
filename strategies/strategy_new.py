...
class StrategyNew(Strategy):
    ...
    def build_tree(self):
        ...
        edge_yes_0cd08 = ChanceEdge(name='yes_cdbae', payoff=0, probability=0.03833333333333333, id='yes_60f50')
        edge_paid_bea96 = DecisionEdge(name='paid_cfd11', payoff=-164243000, id='84b4fb69-d802-2081-4bcc-9d29fe3d4499')
        edge_obtain_key_55398 = ChanceEdge(name='obtain_key_7de5f', payoff=0, probability=0.916, id='obtain_key_4ef51')
        edge_leak_3aa5a = ChanceEdge(name='leak_b23f7', payoff=-11809216, probability=0.44, id='leak_c3a0b')
        node_892f5180_47b6_0e81_8aed_4464a8e3c008 = TerminalNode(name='_a0ad6', id='892f5180-47b6-0e81-8aed-4464a8e3c008')
        edge_no_leak_0f54d = ChanceEdge(name='no_leak_641bd', payoff=0, probability=0.56, id='no_leak_436f7')
        ...
        edge_no_key_eeabc = ChanceEdge(name='no_key_e54e8', payoff=-66045000, probability=0.08399999999999996, id='no_key_3eada')
        edge_leak_9136f = ChanceEdge(name='leak_a5d68', payoff=-136592160, probability=0.44, id='leak_9dd38')
        node_9e3c94db_a639_2da0_905a_ef8ef5443f76 = TerminalNode(name='_33f53', id='9e3c94db-a639-2da0-905a-ef8ef5443f76')
        edge_no_leak_39a4c = ChanceEdge(name='no_leak_a5802', payoff=0, probability=0.56, id='no_leak_5aaa2')
        ...
        edge_no_cfe00 = ChanceEdge(name='no_d05fb', payoff=0, probability=0.9616666666666667, id='no_aeedf')
        ...
        edge_yes_963bc = ChanceEdge(name='yes_3e452', payoff=0, probability=0.03833333333333333, id='yes_c641c')
        edge_paid_27f2c = DecisionEdge(name='paid_35cac', payoff=-164243000, id='6ea6e441-a51e-0dae-0740-8feabce05af6')
        edge_obtain_key_7b725 = ChanceEdge(name='obtain_key_c5771', payoff=0, probability=0.916, id='obtain_key_6ac74')
        edge_leak_2df68 = ChanceEdge(name='leak_54025', payoff=-2429216, probability=0.44, id='leak_02589')
        node_dba2a79e_7241_4660_cbb4_a14f466e5713 = TerminalNode(name='_1a4b5', id='dba2a79e-7241-4660-cbb4-a14f466e5713')
        edge_no_leak_fdd7f = ChanceEdge(name='no_leak_e8be4', payoff=0, probability=0.56, id='no_leak_02c68')
        ...
        edge_no_key_d28ae = ChanceEdge(name='no_key_31650', payoff=-56085000, probability=0.08399999999999996, id='no_key_f9741')
        edge_leak_8e0e9 = ChanceEdge(name='leak_a2e1d', payoff=-136592160, probability=0.44, id='leak_2bda5')
        node_4eef8a6a_d256_c390_f39f_b15d737729d3 = TerminalNode(name='_29eed', id='4eef8a6a-d256-c390-f39f-b15d737729d3')
        edge_no_leak_1da94 = ChanceEdge(name='no_leak_cebec', payoff=0, probability=0.56, id='no_leak_38a67')
        ...
        edge_leak_bce3e = ChanceEdge(name='leak_0cb4e', payoff=-319168, probability=0.44, id='leak_daff6')
        node_3a016884_7d74_c60e_e39b_1dcd89a93bf0 = TerminalNode(name='_26fc1', id='3a016884-7d74-c60e-e39b-1dcd89a93bf0')
        edge_no_leak_d5cee = ChanceEdge(name='no_leak_63029', payoff=0, probability=0.56, id='no_leak_11f1f')
        ...
        edge_no_6cf22 = ChanceEdge(name='no_db3e5', payoff=0, probability=0.9616666666666667, id='no_78b95')
        ...
        edge_yes_b9ad0 = ChanceEdge(name='yes_4a344', payoff=0, probability=0.03833333333333333, id='yes_b136d')
        edge_failed_4a551 = ChanceEdge(name='failed_4c3af', payoff=0, probability=0.6799999999999999, id='failed_83a22')
        edge_paid_26dea = DecisionEdge(name='paid_023c7', payoff=-164243000, id='17839fa6-99f3-0fd5-bc7f-4f8c02c31753')
        edge_obtain_key_94653 = ChanceEdge(name='obtain_key_a1cf5', payoff=0, probability=0.916, id='obtain_key_c12ed')
        edge_leak_8a019 = ChanceEdge(name='leak_2a154', payoff=-2429216, probability=0.44, id='leak_5686a')
        node_83a180b1_5660_749e_44fc_6b0b30243514 = TerminalNode(name='_34b91', id='83a180b1-5660-749e-44fc-6b0b30243514')
        edge_no_leak_f826c = ChanceEdge(name='no_leak_e1ef0', payoff=0, probability=0.56, id='no_leak_9b312')
        ...
        edge_no_key_c6b9e = ChanceEdge(name='no_key_5615a', payoff=-56085000, probability=0.08399999999999996, id='no_key_0bd0b')
        edge_leak_05032 = ChanceEdge(name='leak_4c71f', payoff=-136592160, probability=0.44, id='leak_9e9cb')
        node_73edb5a9_7027_a877_bd1d_6352009d47c3 = TerminalNode(name='_9b152', id='73edb5a9-7027-a877-bd1d-6352009d47c3')
        edge_no_leak_62237 = ChanceEdge(name='no_leak_52d35', payoff=0, probability=0.56, id='no_leak_5e4e7')
        ...
        edge_dont_pay_de811 = DecisionEdge(name='dont_pay_b7b57', payoff=9960000, id='f40f784d-fad7-8795-c224-9d5d61de55b2')
        edge_leak_bf162 = ChanceEdge(name='leak_d3141', payoff=-136592160, probability=0.44, id='leak_a017b')
        node_5300516e_cc7e_566c_3e71_956de1229c89 = TerminalNode(name='_81210', id='5300516e-cc7e-566c-3e71-956de1229c89')
        edge_no_leak_5e7e2 = ChanceEdge(name='no_leak_31e7d', payoff=0, probability=0.56, id='no_leak_b5910')
        ...
        edge_worked_1e707 = ChanceEdge(name='worked_51b7b', payoff=0, probability=0.32, id='worked_0d011')
        edge_leak_03616 = ChanceEdge(name='leak_1eec3', payoff=-2429216, probability=0.44, id='leak_bdcc1')
        node_f2141636_b18c_1d09_5d24_26c7d2333b51 = TerminalNode(name='_15e0e', id='f2141636-b18c-1d09-5d24-26c7d2333b51')
        edge_no_leak_d67f0 = ChanceEdge(name='no_leak_25bf8', payoff=0, probability=0.56, id='no_leak_162c9')
        ...
        edge_no_17cdb = ChanceEdge(name='no_2c2d7', payoff=0, probability=0.9616666666666667, id='no_dc95d')
        ...
        edge__c5c61 = DecisionEdge(name='_25ad2', payoff=-600000, id='91af5e2d-1a5d-34fc-bf26-544ea3e3e18b')
        edge__045e5 = DecisionEdge(name='_c9b63', payoff=0, id='643caf29-f1d2-0c56-854a-5cf639a5bd3e')
        edge_leak_39160 = ChanceEdge(name='leak_68aaa', payoff=-2429216, probability=0.1, id='leak_a820a')
