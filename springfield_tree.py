from nodes import ChanceEdge, ChanceNode, TerminalNode, DecisionEdge, DecisionNode
...
edge_yes_67d71 = ChanceEdge(name='yes_20d6b', payoff=0, probability=0.03833333333333333, id='yes_f864e')
edge_paid_62c2e = DecisionEdge(name='paid_76876', payoff=-164243000, id='84b4fb69-d802-2081-4bcc-9d29fe3d4499')
edge_obtain_key_1c39e = ChanceEdge(name='obtain_key_95df3', payoff=164243000, probability=0.7966666666666666, id='obtain_key_59152')
edge_leak_deb5b = ChanceEdge(name='leak_07f43', payoff=-319168, probability=0.5166666666666667, id='leak_b8ec1')
node_892f5180_47b6_0e81_8aed_4464a8e3c008 = TerminalNode(name='_6a62e', id='892f5180-47b6-0e81-8aed-4464a8e3c008')
edge_no_leak_20eae = ChanceEdge(name='no_leak_359e1', payoff=0, probability=0.4833333333333333, id='no_leak_14d58')
...
edge_no_key_70ebb = ChanceEdge(name='no_key_e40ad', payoff=-66045000, probability=0.20333333333333337, id='no_key_e99a1')
edge_leak_62a58 = ChanceEdge(name='leak_be68e', payoff=-3691680, probability=0.5166666666666667, id='leak_0d3f3')
node_9e3c94db_a639_2da0_905a_ef8ef5443f76 = TerminalNode(name='_ec4ac', id='9e3c94db-a639-2da0-905a-ef8ef5443f76')
edge_no_leak_77cb7 = ChanceEdge(name='no_leak_164ab', payoff=0, probability=0.4833333333333333, id='no_leak_c26b7')
...
edge_no_f8ecc = ChanceEdge(name='no_f4264', payoff=0, probability=0.9616666666666667, id='no_6604a')
...
edge_yes_f19f1 = ChanceEdge(name='yes_0f4da', payoff=0, probability=0.03833333333333333, id='yes_fd112')
edge_paid_b5f8b = DecisionEdge(name='paid_32564', payoff=-164243000, id='6ea6e441-a51e-0dae-0740-8feabce05af6')
edge_obtain_key_f3952 = ChanceEdge(name='obtain_key_d572c', payoff=0, probability=0.7966666666666666, id='obtain_key_fc979')
edge_leak_e63d5 = ChanceEdge(name='leak_12263', payoff=-319168, probability=0.5166666666666667, id='leak_b0be3')
node_dba2a79e_7241_4660_cbb4_a14f466e5713 = TerminalNode(name='_53e9c', id='dba2a79e-7241-4660-cbb4-a14f466e5713')
edge_no_leak_f6dee = ChanceEdge(name='no_leak_edd6a', payoff=0, probability=0.4833333333333333, id='no_leak_eac2c')
...
edge_no_key_ce4ee = ChanceEdge(name='no_key_be221', payoff=-66045000, probability=0.20333333333333337, id='no_key_eb49d')
edge_leak_8093b = ChanceEdge(name='leak_56533', payoff=-3691680, probability=0.5166666666666667, id='leak_e93e4')
node_4eef8a6a_d256_c390_f39f_b15d737729d3 = TerminalNode(name='_75f51', id='4eef8a6a-d256-c390-f39f-b15d737729d3')
edge_no_leak_eb3c9 = ChanceEdge(name='no_leak_14286', payoff=0, probability=0.4833333333333333, id='no_leak_d54f9')
...
edge_leak_034c7 = ChanceEdge(name='leak_dbece', payoff=-319168, probability=0.5166666666666667, id='leak_44936')
node_3a016884_7d74_c60e_e39b_1dcd89a93bf0 = TerminalNode(name='_b97dd', id='3a016884-7d74-c60e-e39b-1dcd89a93bf0')
edge_no_leak_80643 = ChanceEdge(name='no_leak_6ad7d', payoff=0, probability=0.4833333333333333, id='no_leak_57b82')
...
edge_no_6054f = ChanceEdge(name='no_86dcf', payoff=0, probability=0.9616666666666667, id='no_1268d')
...
edge_yes_7910c = ChanceEdge(name='yes_d196d', payoff=0, probability=0.03833333333333333, id='yes_10897')
edge_failed_c253b = ChanceEdge(name='failed_ee33f', payoff=0, probability=0.7316666666666667, id='failed_ff0d4')
edge_paid_a3557 = DecisionEdge(name='paid_2b068', payoff=-164243000, id='17839fa6-99f3-0fd5-bc7f-4f8c02c31753')
edge_obtain_key_504ce = ChanceEdge(name='obtain_key_df083', payoff=0, probability=0.7966666666666666, id='obtain_key_682b8')
edge_leak_268dc = ChanceEdge(name='leak_cb935', payoff=-319168, probability=0.5166666666666667, id='leak_6f71b')
node_83a180b1_5660_749e_44fc_6b0b30243514 = TerminalNode(name='_18294', id='83a180b1-5660-749e-44fc-6b0b30243514')
edge_no_leak_b6d92 = ChanceEdge(name='no_leak_e0502', payoff=0, probability=0.4833333333333333, id='no_leak_442cd')
...
edge_no_key_2645a = ChanceEdge(name='no_key_10a90', payoff=-66045000, probability=0.20333333333333337, id='no_key_2544d')
edge_leak_b1a2d = ChanceEdge(name='leak_3c622', payoff=-3691680, probability=0.5166666666666667, id='leak_8bd13')
node_73edb5a9_7027_a877_bd1d_6352009d47c3 = TerminalNode(name='_c2d67', id='73edb5a9-7027-a877-bd1d-6352009d47c3')
edge_no_leak_02f15 = ChanceEdge(name='no_leak_d348f', payoff=0, probability=0.4833333333333333, id='no_leak_859cf')
...
edge_leak_a304e = ChanceEdge(name='leak_5fac7', payoff=-3691680, probability=0.5166666666666667, id='leak_5ab72')
node_5300516e_cc7e_566c_3e71_956de1229c89 = TerminalNode(name='_c35b2', id='5300516e-cc7e-566c-3e71-956de1229c89')
edge_no_leak_a0709 = ChanceEdge(name='no_leak_636cb', payoff=0, probability=0.4833333333333333, id='no_leak_caee7')
...
edge__65f92 = ChanceEdge(name='_508e6', payoff=0, probability=0.2683333333333333, id='_e705f')
edge_leak_ef2a0 = ChanceEdge(name='leak_10e9f', payoff=-319168, probability=0.5166666666666667, id='leak_d39b4')
node_f2141636_b18c_1d09_5d24_26c7d2333b51 = TerminalNode(name='_e5c6c', id='f2141636-b18c-1d09-5d24-26c7d2333b51')
edge_no_leak_b65e9 = ChanceEdge(name='no_leak_1a35c', payoff=0, probability=0.4833333333333333, id='no_leak_aa4ae')
...
edge_no_788ba = ChanceEdge(name='no_06408', payoff=0, probability=0.9616666666666667, id='no_4997a')
...
node_e8adc128_108b_ad97_f793_451b491a9f00 = DecisionNode(name='in_house_it_security_department_with_end_user_training_insurance_e8ba2', id='e8adc128-108b-ad97-f793-451b491a9f00', edges=[edge__b45f3, edge__0e0d9])
edge__66199 = DecisionEdge(name='_6d70d', payoff=-600000, id='91af5e2d-1a5d-34fc-bf26-544ea3e3e18b')
edge__5e316 = DecisionEdge(name='_d7694', payoff=0, id='643caf29-f1d2-0c56-854a-5cf639a5bd3e')
edge_leak_ea176 = ChanceEdge(name='leak_aaa6f', payoff=-319168, probability=0.1, id='leak_a06ad')
...
node_d45d94b0_302e_442d_5069_267cc52167ee = DecisionNode(name='external_it_securityinsurance_included_5dac9', id='d45d94b0-302e-442d-5069-267cc52167ee', edges=[edge__5e316])
...
edge__1791c.result_node = node_e8adc128_108b_ad97_f793_451b491a9f00
...
edge__66199.result_node = node_d45d94b0_302e_442d_5069_267cc52167ee
...
node_9bd785f6_e6fc_af5c_3eb9_b79e0d029cd7.print_tree()